...
static void auto_filetype_function(void){}	
...
static int df_max_bininfo_cols = 0;     
...
plot_option_binary(TBOOLEAN set_matrix, TBOOLEAN set_default)
{
	...
	if (almost_equals(c_token, "end$ian")) {
		...
		df_bin_file_endianess = (~df_bin_file_endianess)&3; 
